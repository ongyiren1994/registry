...
main = Aff.launchAff_ do
  ...
  case parseJsonMap bowerPackagesStr, parseJsonMap newPackagesStr of
    ...
    Right bowerPackages, Right newPackages -> do
      ...
      --
      -- TODO: What about packages in the registry that aren't on GitHub?
      -- TODO: Should we pull from GitHub tags instead of releases? Many folks use tags
      -- only and not explicit releases.
